...
from terrasnek import endpoint
...
class TestWorkspaces(TestCase):
    ...
    def setUp(self) -> None:
        self.api = TFC("test_token", verify=True)
    ...
    def test_workspace_create(self):
        ...
        with patch.object(endpoint, "requests") as mock_requests:
    ...
    def test_list_all_resources(self):
        ...
        with patch.object(endpoint, "requests") as mock_requests:
            ...
            self.api.workspaces.list_all_resources(
                workspace_id="ws-123456",
            )
